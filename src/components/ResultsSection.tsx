      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-background text-foreground rounded-2xl p-8 md:p-12 text-center border">
          ...
          <button 
            ...
            onClick={() => window.open('https://wa.me/5531984005700?text=Ol%C3%A1!%20Gostaria%20de%20saber%20mais%20informa%C3%A7%C3%B5es%20sobre%20o%20agente%20de%20IA.', '_blank')}
          >
